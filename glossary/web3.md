...
### xDAI Network
The Ethereum mainnet has seen tremendous activity in recent months. Because of this, we have created a new instances of our DAO on the [xDAI network](https://www.xdaichain.com/). [xDAI](https://www.xdaichain.com/) is a network that bridges to Ethereum's mainnet, and allows us to create new transactions for a few cents (in xDAI).
