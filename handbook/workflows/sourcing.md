...
{% hint style="info" %}
In addition to a well-balanced set of members that match the project’s needs, each execution team must have a [_Project Manager_](project-manager.md) and [_QA Lead_](qa-lead.md)__
{% endhint %}
...
1. Once the proposal passes, create a [Gnosis Safe](https://gnosis-safe.io/app/#/welcome) on mainnet or Polygon with the _Sourcing Lead_, _Project Manager_, _QA Lead_, and all other committed members as signers. Examples of required signers: 2/3, 3/5, 4/6, 4/7.
...
4. Continue to invoice on the agreed upon schedule. Regularly monitor the project's health through the _Project Manager_ and _QA Lead_, making sure to step in and help resolve any issues that arise.
