...
2. **Create a @dorg.tech email address at** [**https://admin.google.com/**](https://admin.google.com) **** using their first name (or first plus last if its already taken). Click Add New User, enter info, click preview and send.
